...
Download "xcat-inventory" package from [xcat-inventory](https://github.com/xcat2/xcat-inventory/releases/download/v0.1.3/xcat-inventory-0.1.3-c1.noarch.rpm) to xCAT management node, and run `yum install xcat-inventory.rpm` to install it
